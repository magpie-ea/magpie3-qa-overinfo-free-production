...
df_answerOptions_global_summary %>%
  mutate(answerType = factor(answerType, levels = answerOrder, labels = c("competitor (iced coffee)", "similar option (soda)", "unrelated option (Chardonnay)", "all options", "no option", "other"))) %>%
...
#ggsave("viz/e1_free_production_global_answerTypes_cogsci.pdf", width = 8, height = 6)

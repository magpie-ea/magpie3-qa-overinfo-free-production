...
lm_scores_byModel <- lm_scores_byModel %>% 
  rbind(., gpt3_oneshot_summary) %>%
  rbind(., gpt3_zeroshot_summary)
...
Fit a multinomial model on model data and compute a posterior predictive probability on *human* data.
